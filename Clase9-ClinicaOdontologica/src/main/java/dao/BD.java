...
public class BD {
    ...
    private static final String SQL_DROP_CREATE_ODONTOLOGOS="DROP TABLE IF EXISTS ODONTOLOGOS; CREATE TABLE ODONTOLOGOS(ID INT AUTO_INCREMENT PRIMARY KEY, NOMBRE VARCHAR(100) NOT NULL, APELLIDO VARCHAR(100) NOT NULL, MATRICULA INT NOT NULL UNIQUE)";
    ...
    private static final String pruebaOdo="INSERT INTO ODONTOLOGOS(NOMBRE, APELLIDO, MATRICULA) VALUES('Juan', 'Perez','123'),('Maria','Laura','5560')";
...
//primero deberia llamar a la conexion
    ...
    try{
        ...
        statement.execute(pruebaOdo);
        System.out.println("Datos Persistidos Ingreso Inicial");
    }catch (Exception e){
    ...
    public static Connection getConnection() throws Exception{
        ...
        return DriverManager.getConnection("jdbc:h2:tcp://localhost/~/clinicaFeliz;AUTO_SERVER=TRUE",
                "sa","sa");
